# `Eu` profile for `pubchem`

This report summarizes how often the target element `Eu` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Eu`. A molecule is **negative** when its formula does not contain `Eu`.
...
| Positive count | 5588 |
| Negative count | 123924601 |
| Positive percentage | 0.0045% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Eu`.
The `0` row represents formulas that do not contain `Eu`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Eu atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 5588 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 5588 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 5588 | 0.00% | 100.00% |
