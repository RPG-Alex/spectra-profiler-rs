# `Sr` profile for `pubchem`

This report summarizes how often the target element `Sr` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Sr`. A molecule is **negative** when its formula does not contain `Sr`.
...
| Positive count | 8275 |
| Negative count | 123921914 |
| Positive percentage | 0.0067% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Sr`.
The `0` row represents formulas that do not contain `Sr`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Sr atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 8275 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 8275 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 8275 | 0.01% | 100.00% |
