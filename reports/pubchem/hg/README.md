# `Hg` profile for `pubchem`

This report summarizes how often the target element `Hg` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Hg`. A molecule is **negative** when its formula does not contain `Hg`.
...
| Positive count | 15125 |
| Negative count | 123915064 |
| Positive percentage | 0.0122% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Hg`.
The `0` row represents formulas that do not contain `Hg`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Hg atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 15125 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 15125 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 15125 | 0.01% | 100.00% |
