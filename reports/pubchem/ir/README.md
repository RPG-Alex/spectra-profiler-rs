# `Ir` profile for `pubchem`

This report summarizes how often the target element `Ir` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Ir`. A molecule is **negative** when its formula does not contain `Ir`.
...
| Positive count | 161636 |
| Negative count | 123768553 |
| Positive percentage | 0.1304% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Ir`.
The `0` row represents formulas that do not contain `Ir`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Ir atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 161636 | 0.13% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 161636 | 0.13% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 161636 | 0.13% | 100.00% |
