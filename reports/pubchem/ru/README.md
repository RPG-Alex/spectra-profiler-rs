# `Ru` profile for `pubchem`

This report summarizes how often the target element `Ru` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Ru`. A molecule is **negative** when its formula does not contain `Ru`.
...
| Positive count | 38960 |
| Negative count | 123891229 |
| Positive percentage | 0.0314% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Ru`.
The `0` row represents formulas that do not contain `Ru`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Ru atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 38960 | 0.03% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 38960 | 0.03% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 38960 | 0.03% | 100.00% |
