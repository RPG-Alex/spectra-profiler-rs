# `Rh` profile for `pubchem`

This report summarizes how often the target element `Rh` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Rh`. A molecule is **negative** when its formula does not contain `Rh`.
...
| Positive count | 14844 |
| Negative count | 123915345 |
| Positive percentage | 0.0120% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Rh`.
The `0` row represents formulas that do not contain `Rh`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Rh atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 14844 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 14844 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 14844 | 0.01% | 100.00% |
