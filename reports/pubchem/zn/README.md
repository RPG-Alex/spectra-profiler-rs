# `Zn` profile for `pubchem`

This report summarizes how often the target element `Zn` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Zn`. A molecule is **negative** when its formula does not contain `Zn`.
...
| Positive count | 75927 |
| Negative count | 123854262 |
| Positive percentage | 0.0613% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Zn`.
The `0` row represents formulas that do not contain `Zn`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Zn atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 75927 | 0.06% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 75927 | 0.06% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 75927 | 0.06% | 100.00% |
