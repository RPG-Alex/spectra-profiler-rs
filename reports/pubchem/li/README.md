# `Li` profile for `pubchem`

This report summarizes how often the target element `Li` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Li`. A molecule is **negative** when its formula does not contain `Li`.
...
| Positive count | 116808 |
| Negative count | 123813381 |
| Positive percentage | 0.0943% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Li`.
The `0` row represents formulas that do not contain `Li`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Li atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 116808 | 0.09% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 116808 | 0.09% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 116808 | 0.09% | 100.00% |
