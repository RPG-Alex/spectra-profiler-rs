# `Te` profile for `pubchem`

This report summarizes how often the target element `Te` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Te`. A molecule is **negative** when its formula does not contain `Te`.
...
| Positive count | 20419 |
| Negative count | 123909770 |
| Positive percentage | 0.0165% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Te`.
The `0` row represents formulas that do not contain `Te`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Te atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 20419 | 0.02% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 20419 | 0.02% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 20419 | 0.02% | 100.00% |
