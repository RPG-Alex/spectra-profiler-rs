# `Ce` profile for `pubchem`

This report summarizes how often the target element `Ce` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Ce`. A molecule is **negative** when its formula does not contain `Ce`.
...
| Positive count | 8210 |
| Negative count | 123921979 |
| Positive percentage | 0.0066% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Ce`.
The `0` row represents formulas that do not contain `Ce`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Ce atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 8210 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 8210 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 8210 | 0.01% | 100.00% |
