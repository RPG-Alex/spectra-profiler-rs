# `U` profile for `pubchem`

This report summarizes how often the target element `U` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `U`. A molecule is **negative** when its formula does not contain `U`.
...
| Positive count | 21201 |
| Negative count | 123908988 |
| Positive percentage | 0.0171% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `U`.
The `0` row represents formulas that do not contain `U`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="U atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 21201 | 0.02% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 21201 | 0.02% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 21201 | 0.02% | 100.00% |
