# `B` profile for `pubchem`

This report summarizes how often the target element `B` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `B`. A molecule is **negative** when its formula does not contain `B`.
...
| Positive count | 1291936 |
| Negative count | 122638253 |
| Positive percentage | 1.0425% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `B`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 1291936 | 1.04% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 1291936 | 1.04% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 1291936 | 1.04% | 100.00% |
