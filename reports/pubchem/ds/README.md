# `Ds` profile for `pubchem`

This report summarizes how often the target element `Ds` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Ds`. A molecule is **negative** when its formula does not contain `Ds`.
...
| Positive count | 11 |
| Negative count | 123930178 |
| Positive percentage | 0.0000% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Ds`.
The `0` row represents formulas that do not contain `Ds`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Ds atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 11 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 11 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 11 | 0.00% | 100.00% |
