# `Br` profile for `pubchem`

This report summarizes how often the target element `Br` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Br`. A molecule is **negative** when its formula does not contain `Br`.
...
| Positive count | 8576070 |
| Negative count | 115354119 |
| Positive percentage | 6.9201% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Br`.
The `0` row represents formulas that do not contain `Br`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Br atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 8576070 | 6.92% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 8576070 | 6.92% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 8576070 | 6.92% | 100.00% |
