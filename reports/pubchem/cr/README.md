# `Cr` profile for `pubchem`

This report summarizes how often the target element `Cr` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Cr`. A molecule is **negative** when its formula does not contain `Cr`.
...
| Positive count | 27025 |
| Negative count | 123903164 |
| Positive percentage | 0.0218% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Cr`.
The `0` row represents formulas that do not contain `Cr`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Cr atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 27025 | 0.02% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 27025 | 0.02% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 27025 | 0.02% | 100.00% |
