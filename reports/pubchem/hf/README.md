# `Hf` profile for `pubchem`

This report summarizes how often the target element `Hf` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Hf`. A molecule is **negative** when its formula does not contain `Hf`.
...
| Positive count | 21977 |
| Negative count | 123908212 |
| Positive percentage | 0.0177% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Hf`.
The `0` row represents formulas that do not contain `Hf`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Hf atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 21977 | 0.02% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 21977 | 0.02% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 21977 | 0.02% | 100.00% |
