# `Al` profile for `pubchem`

This report summarizes how often the target element `Al` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Al`. A molecule is **negative** when its formula does not contain `Al`.
...
| Positive count | 82180 |
| Negative count | 123848009 |
| Positive percentage | 0.0663% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Al`.
The `0` row represents formulas that do not contain `Al`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Al atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 82180 | 0.07% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 82180 | 0.07% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 82180 | 0.07% | 100.00% |
