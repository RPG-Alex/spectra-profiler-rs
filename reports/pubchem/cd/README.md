# `Cd` profile for `pubchem`

This report summarizes how often the target element `Cd` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Cd`. A molecule is **negative** when its formula does not contain `Cd`.
...
| Positive count | 7940 |
| Negative count | 123922249 |
| Positive percentage | 0.0064% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Cd`.
The `0` row represents formulas that do not contain `Cd`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Cd atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 7940 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 7940 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 7940 | 0.01% | 100.00% |
