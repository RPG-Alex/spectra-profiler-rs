# `Cl` profile for `pubchem`

This report summarizes how often the target element `Cl` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Cl`. A molecule is **negative** when its formula does not contain `Cl`.
...
| Positive count | 21810735 |
| Negative count | 102119454 |
| Positive percentage | 17.5992% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Cl`.
The `0` row represents formulas that do not contain `Cl`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Cl atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 21810735 | 17.60% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 21810735 | 17.60% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 21810735 | 17.60% | 100.00% |
