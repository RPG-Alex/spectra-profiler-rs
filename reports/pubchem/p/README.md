# `P` profile for `pubchem`

This report summarizes how often the target element `P` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `P`. A molecule is **negative** when its formula does not contain `P`.
...
| Positive count | 2487337 |
| Negative count | 121442852 |
| Positive percentage | 2.0070% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `P`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 2487337 | 2.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 2487337 | 2.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 2487337 | 2.01% | 100.00% |
