# `Hs` profile for `pubchem`

This report summarizes how often the target element `Hs` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Hs`. A molecule is **negative** when its formula does not contain `Hs`.
...
| Positive count | 69 |
| Negative count | 123930120 |
| Positive percentage | 0.0001% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Hs`.
The `0` row represents formulas that do not contain `Hs`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Hs atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 69 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 69 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 69 | 0.00% | 100.00% |
