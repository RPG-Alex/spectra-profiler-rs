# `La` profile for `pubchem`

This report summarizes how often the target element `La` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `La`. A molecule is **negative** when its formula does not contain `La`.
...
| Positive count | 8057 |
| Negative count | 123922132 |
| Positive percentage | 0.0065% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `La`.
The `0` row represents formulas that do not contain `La`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="La atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 8057 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 8057 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 8057 | 0.01% | 100.00% |
