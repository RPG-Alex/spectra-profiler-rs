# `Cf` profile for `pubchem`

This report summarizes how often the target element `Cf` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Cf`. A molecule is **negative** when its formula does not contain `Cf`.
...
| Positive count | 230 |
| Negative count | 123929959 |
| Positive percentage | 0.0002% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Cf`.
The `0` row represents formulas that do not contain `Cf`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Cf atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 230 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 230 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 230 | 0.00% | 100.00% |
