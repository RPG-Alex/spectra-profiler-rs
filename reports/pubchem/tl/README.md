# `Tl` profile for `pubchem`

This report summarizes how often the target element `Tl` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Tl`. A molecule is **negative** when its formula does not contain `Tl`.
...
| Positive count | 6100 |
| Negative count | 123924089 |
| Positive percentage | 0.0049% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Tl`.
The `0` row represents formulas that do not contain `Tl`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Tl atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 6100 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 6100 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 6100 | 0.00% | 100.00% |
