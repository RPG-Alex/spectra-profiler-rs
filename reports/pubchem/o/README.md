# `O` profile for `pubchem`

This report summarizes how often the target element `O` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `O`. A molecule is **negative** when its formula does not contain `O`.
...
| Positive count | 108803862 |
| Negative count | 15126327 |
| Positive percentage | 87.7945% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `O`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 108803862 | 87.79% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 108803862 | 87.79% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 108803862 | 87.79% | 100.00% |
