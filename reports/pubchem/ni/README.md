# `Ni` profile for `pubchem`

This report summarizes how often the target element `Ni` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Ni`. A molecule is **negative** when its formula does not contain `Ni`.
...
| Positive count | 50336 |
| Negative count | 123879853 |
| Positive percentage | 0.0406% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Ni`.
The `0` row represents formulas that do not contain `Ni`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Ni atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 50336 | 0.04% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 50336 | 0.04% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 50336 | 0.04% | 100.00% |
