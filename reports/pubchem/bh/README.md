# `Bh` profile for `pubchem`

This report summarizes how often the target element `Bh` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Bh`. A molecule is **negative** when its formula does not contain `Bh`.
...
| Positive count | 74 |
| Negative count | 123930115 |
| Positive percentage | 0.0001% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Bh`.
The `0` row represents formulas that do not contain `Bh`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Bh atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 74 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 74 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 74 | 0.00% | 100.00% |
