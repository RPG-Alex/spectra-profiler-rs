# `Ts` profile for `pubchem`

This report summarizes how often the target element `Ts` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Ts`. A molecule is **negative** when its formula does not contain `Ts`.
...
| Positive count | 3 |
| Negative count | 123930186 |
| Positive percentage | 0.0000% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Ts`.
The `0` row represents formulas that do not contain `Ts`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Ts atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 3 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 3 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 3 | 0.00% | 100.00% |
