# `Pt` profile for `pubchem`

This report summarizes how often the target element `Pt` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Pt`. A molecule is **negative** when its formula does not contain `Pt`.
...
| Positive count | 139438 |
| Negative count | 123790751 |
| Positive percentage | 0.1125% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Pt`.
The `0` row represents formulas that do not contain `Pt`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Pt atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 139438 | 0.11% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 139438 | 0.11% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 139438 | 0.11% | 100.00% |
