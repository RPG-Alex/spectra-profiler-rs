# `I` profile for `pubchem`

This report summarizes how often the target element `I` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `I`. A molecule is **negative** when its formula does not contain `I`.
...
| Positive count | 2533762 |
| Negative count | 121396427 |
| Positive percentage | 2.0445% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `I`.
The `0` row represents formulas that do not contain `I`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="I atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 2533762 | 2.04% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 2533762 | 2.04% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 2533762 | 2.04% | 100.00% |
