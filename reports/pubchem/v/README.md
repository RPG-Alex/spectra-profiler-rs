# `V` profile for `pubchem`

This report summarizes how often the target element `V` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `V`. A molecule is **negative** when its formula does not contain `V`.
...
| Positive count | 39548 |
| Negative count | 123890641 |
| Positive percentage | 0.0319% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `V`.
The `0` row represents formulas that do not contain `V`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="V atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 39548 | 0.03% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 39548 | 0.03% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 39548 | 0.03% | 100.00% |
