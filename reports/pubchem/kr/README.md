# `Kr` profile for `pubchem`

This report summarizes how often the target element `Kr` appears across metadata groups in `pubchem`.
...
<img src="figures/target_atom_count_distribution.svg" alt="Kr atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 166 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 166 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 166 | 0.00% | 100.00% |
