# `Nb` profile for `pubchem`

This report summarizes how often the target element `Nb` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Nb`. A molecule is **negative** when its formula does not contain `Nb`.
...
| Positive count | 6583 |
| Negative count | 123923606 |
| Positive percentage | 0.0053% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Nb`.
The `0` row represents formulas that do not contain `Nb`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Nb atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 6583 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 6583 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 6583 | 0.01% | 100.00% |
