# `H` profile for `pubchem`

This report summarizes how often the target element `H` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `H`. A molecule is **negative** when its formula does not contain `H`.
...
| Positive count | 123803117 |
| Negative count | 127072 |
| Positive percentage | 99.8975% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `H`.
The `0` row represents formulas that do not contain `H`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="H atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 123803117 | 99.90% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 123803117 | 99.90% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 123803117 | 99.90% | 100.00% |
