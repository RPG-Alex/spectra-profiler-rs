# `Gd` profile for `pubchem`

This report summarizes how often the target element `Gd` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Gd`. A molecule is **negative** when its formula does not contain `Gd`.
...
| Positive count | 7696 |
| Negative count | 123922493 |
| Positive percentage | 0.0062% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Gd`.
The `0` row represents formulas that do not contain `Gd`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Gd atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 7696 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 7696 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 7696 | 0.01% | 100.00% |
