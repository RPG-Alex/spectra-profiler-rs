# `Er` profile for `pubchem`

This report summarizes how often the target element `Er` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Er`. A molecule is **negative** when its formula does not contain `Er`.
...
| Positive count | 2190 |
| Negative count | 123927999 |
| Positive percentage | 0.0018% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Er`.
The `0` row represents formulas that do not contain `Er`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Er atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 2190 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 2190 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 2190 | 0.00% | 100.00% |
