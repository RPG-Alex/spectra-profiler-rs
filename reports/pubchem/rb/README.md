# `Rb` profile for `pubchem`

This report summarizes how often the target element `Rb` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Rb`. A molecule is **negative** when its formula does not contain `Rb`.
...
| Positive count | 10891 |
| Negative count | 123919298 |
| Positive percentage | 0.0088% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Rb`.
The `0` row represents formulas that do not contain `Rb`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Rb atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 10891 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 10891 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 10891 | 0.01% | 100.00% |
