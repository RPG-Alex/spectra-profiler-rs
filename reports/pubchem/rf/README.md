# `Rf` profile for `pubchem`

This report summarizes how often the target element `Rf` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Rf`. A molecule is **negative** when its formula does not contain `Rf`.
...
| Positive count | 5122 |
| Negative count | 123925067 |
| Positive percentage | 0.0041% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Rf`.
The `0` row represents formulas that do not contain `Rf`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Rf atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 5122 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 5122 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 5122 | 0.00% | 100.00% |
