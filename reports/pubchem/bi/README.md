# `Bi` profile for `pubchem`

This report summarizes how often the target element `Bi` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Bi`. A molecule is **negative** when its formula does not contain `Bi`.
...
| Positive count | 15608 |
| Negative count | 123914581 |
| Positive percentage | 0.0126% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Bi`.
The `0` row represents formulas that do not contain `Bi`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Bi atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 15608 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 15608 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 15608 | 0.01% | 100.00% |
