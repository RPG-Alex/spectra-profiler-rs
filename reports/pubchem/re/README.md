# `Re` profile for `pubchem`

This report summarizes how often the target element `Re` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Re`. A molecule is **negative** when its formula does not contain `Re`.
...
| Positive count | 10108 |
| Negative count | 123920081 |
| Positive percentage | 0.0082% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Re`.
The `0` row represents formulas that do not contain `Re`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Re atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 10108 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 10108 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 10108 | 0.01% | 100.00% |
