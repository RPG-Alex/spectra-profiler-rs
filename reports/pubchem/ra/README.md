# `Ra` profile for `pubchem`

This report summarizes how often the target element `Ra` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Ra`. A molecule is **negative** when its formula does not contain `Ra`.
...
| Positive count | 275 |
| Negative count | 123929914 |
| Positive percentage | 0.0002% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Ra`.
The `0` row represents formulas that do not contain `Ra`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Ra atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 275 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 275 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 275 | 0.00% | 100.00% |
