# `Ta` profile for `pubchem`

This report summarizes how often the target element `Ta` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Ta`. A molecule is **negative** when its formula does not contain `Ta`.
...
| Positive count | 5718 |
| Negative count | 123924471 |
| Positive percentage | 0.0046% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Ta`.
The `0` row represents formulas that do not contain `Ta`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Ta atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 5718 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 5718 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 5718 | 0.00% | 100.00% |
