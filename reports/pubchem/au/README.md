# `Au` profile for `pubchem`

This report summarizes how often the target element `Au` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Au`. A molecule is **negative** when its formula does not contain `Au`.
...
| Positive count | 17871 |
| Negative count | 123912318 |
| Positive percentage | 0.0144% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Au`.
The `0` row represents formulas that do not contain `Au`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Au atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 17871 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 17871 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 17871 | 0.01% | 100.00% |
