# `Fm` profile for `pubchem`

This report summarizes how often the target element `Fm` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Fm`. A molecule is **negative** when its formula does not contain `Fm`.
...
| Positive count | 2065 |
| Negative count | 123928124 |
| Positive percentage | 0.0017% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Fm`.
The `0` row represents formulas that do not contain `Fm`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Fm atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 2065 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 2065 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 2065 | 0.00% | 100.00% |
