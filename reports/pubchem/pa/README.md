# `Pa` profile for `pubchem`

This report summarizes how often the target element `Pa` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Pa`. A molecule is **negative** when its formula does not contain `Pa`.
...
| Positive count | 259 |
| Negative count | 123929930 |
| Positive percentage | 0.0002% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Pa`.
The `0` row represents formulas that do not contain `Pa`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Pa atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 259 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 259 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 259 | 0.00% | 100.00% |
