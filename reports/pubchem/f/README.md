# `F` profile for `pubchem`

This report summarizes how often the target element `F` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `F`. A molecule is **negative** when its formula does not contain `F`.
...
| Positive count | 25132174 |
| Negative count | 98798015 |
| Positive percentage | 20.2793% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `F`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 25132174 | 20.28% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 25132174 | 20.28% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 25132174 | 20.28% | 100.00% |
