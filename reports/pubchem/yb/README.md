# `Yb` profile for `pubchem`

This report summarizes how often the target element `Yb` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Yb`. A molecule is **negative** when its formula does not contain `Yb`.
...
| Positive count | 3273 |
| Negative count | 123926916 |
| Positive percentage | 0.0026% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Yb`.
The `0` row represents formulas that do not contain `Yb`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Yb atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 3273 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 3273 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 3273 | 0.00% | 100.00% |
