# `K` profile for `pubchem`

This report summarizes how often the target element `K` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `K`. A molecule is **negative** when its formula does not contain `K`.
...
| Positive count | 155106 |
| Negative count | 123775083 |
| Positive percentage | 0.1252% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `K`.
The `0` row represents formulas that do not contain `K`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="K atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 155106 | 0.13% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 155106 | 0.13% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 155106 | 0.13% | 100.00% |
