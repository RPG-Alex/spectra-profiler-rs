# `Tc` profile for `pubchem`

This report summarizes how often the target element `Tc` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Tc`. A molecule is **negative** when its formula does not contain `Tc`.
...
| Positive count | 3661 |
| Negative count | 123926528 |
| Positive percentage | 0.0030% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Tc`.
The `0` row represents formulas that do not contain `Tc`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Tc atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 3661 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 3661 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 3661 | 0.00% | 100.00% |
