# `C` profile for `pubchem`

This report summarizes how often the target element `C` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `C`. A molecule is **negative** when its formula does not contain `C`.
...
| Positive count | 123718939 |
| Negative count | 211250 |
| Positive percentage | 99.8295% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `C`.
The `0` row represents formulas that do not contain `C`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="C atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 123718939 | 99.83% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 123718939 | 99.83% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 123718939 | 99.83% | 100.00% |
