# `Se` profile for `pubchem`

This report summarizes how often the target element `Se` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Se`. A molecule is **negative** when its formula does not contain `Se`.
...
| Positive count | 118139 |
| Negative count | 123812050 |
| Positive percentage | 0.0953% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Se`.
The `0` row represents formulas that do not contain `Se`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Se atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 118139 | 0.10% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 118139 | 0.10% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 118139 | 0.10% | 100.00% |
