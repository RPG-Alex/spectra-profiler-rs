# `W` profile for `pubchem`

This report summarizes how often the target element `W` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `W`. A molecule is **negative** when its formula does not contain `W`.
...
| Positive count | 43802 |
| Negative count | 123886387 |
| Positive percentage | 0.0353% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `W`.
The `0` row represents formulas that do not contain `W`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="W atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 43802 | 0.04% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 43802 | 0.04% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 43802 | 0.04% | 100.00% |
