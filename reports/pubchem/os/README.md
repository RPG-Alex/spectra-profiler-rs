# `Os` profile for `pubchem`

This report summarizes how often the target element `Os` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Os`. A molecule is **negative** when its formula does not contain `Os`.
...
| Positive count | 8598 |
| Negative count | 123921591 |
| Positive percentage | 0.0069% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Os`.
The `0` row represents formulas that do not contain `Os`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Os atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 8598 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 8598 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 8598 | 0.01% | 100.00% |
