# `In` profile for `pubchem`

This report summarizes how often the target element `In` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `In`. A molecule is **negative** when its formula does not contain `In`.
...
| Positive count | 13932 |
| Negative count | 123916257 |
| Positive percentage | 0.0112% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `In`.
The `0` row represents formulas that do not contain `In`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="In atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 13932 | 0.01% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 13932 | 0.01% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 13932 | 0.01% | 100.00% |
