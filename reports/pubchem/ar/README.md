# `Ar` profile for `pubchem`

This report summarizes how often the target element `Ar` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Ar`. A molecule is **negative** when its formula does not contain `Ar`.
...
| Positive count | 4077 |
| Negative count | 123926112 |
| Positive percentage | 0.0033% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Ar`.
The `0` row represents formulas that do not contain `Ar`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Ar atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 4077 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 4077 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 4077 | 0.00% | 100.00% |
