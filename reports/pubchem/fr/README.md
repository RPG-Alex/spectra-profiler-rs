# `Fr` profile for `pubchem`

This report summarizes how often the target element `Fr` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Fr`. A molecule is **negative** when its formula does not contain `Fr`.
...
| Positive count | 105 |
| Negative count | 123930084 |
| Positive percentage | 0.0001% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Fr`.
The `0` row represents formulas that do not contain `Fr`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Fr atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 105 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 105 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 105 | 0.00% | 100.00% |
