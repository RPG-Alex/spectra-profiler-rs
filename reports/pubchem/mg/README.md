# `Mg` profile for `pubchem`

This report summarizes how often the target element `Mg` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Mg`. A molecule is **negative** when its formula does not contain `Mg`.
...
| Positive count | 62803 |
| Negative count | 123867386 |
| Positive percentage | 0.0507% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Mg`.
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 62803 | 0.05% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 62803 | 0.05% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 62803 | 0.05% | 100.00% |
