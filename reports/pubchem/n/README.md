# `N` profile for `pubchem`

This report summarizes how often the target element `N` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `N`. A molecule is **negative** when its formula does not contain `N`.
...
| Positive count | 110333086 |
| Negative count | 13597103 |
| Positive percentage | 89.0284% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `N`.
The `0` row represents formulas that do not contain `N`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="N atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 110333086 | 89.03% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 110333086 | 89.03% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 110333086 | 89.03% | 100.00% |
