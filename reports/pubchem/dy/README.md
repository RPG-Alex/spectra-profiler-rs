# `Dy` profile for `pubchem`

This report summarizes how often the target element `Dy` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Dy`. A molecule is **negative** when its formula does not contain `Dy`.
...
| Positive count | 2307 |
| Negative count | 123927882 |
| Positive percentage | 0.0019% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Dy`.
The `0` row represents formulas that do not contain `Dy`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Dy atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 2307 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 2307 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 2307 | 0.00% | 100.00% |
