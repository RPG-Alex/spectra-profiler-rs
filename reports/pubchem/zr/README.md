# `Zr` profile for `pubchem`

This report summarizes how often the target element `Zr` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Zr`. A molecule is **negative** when its formula does not contain `Zr`.
...
| Positive count | 106560 |
| Negative count | 123823629 |
| Positive percentage | 0.0860% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Zr`.
The `0` row represents formulas that do not contain `Zr`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Zr atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 106560 | 0.09% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 106560 | 0.09% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 106560 | 0.09% | 100.00% |
