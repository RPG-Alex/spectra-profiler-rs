# `Pd` profile for `pubchem`

This report summarizes how often the target element `Pd` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Pd`. A molecule is **negative** when its formula does not contain `Pd`.
...
| Positive count | 48618 |
| Negative count | 123881571 |
| Positive percentage | 0.0392% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Pd`.
The `0` row represents formulas that do not contain `Pd`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Pd atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 48618 | 0.04% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 48618 | 0.04% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 48618 | 0.04% | 100.00% |
