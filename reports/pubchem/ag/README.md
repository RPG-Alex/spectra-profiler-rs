# `Ag` profile for `pubchem`

This report summarizes how often the target element `Ag` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Ag`. A molecule is **negative** when its formula does not contain `Ag`.
...
| Positive count | 19057 |
| Negative count | 123911132 |
| Positive percentage | 0.0154% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Ag`.
The `0` row represents formulas that do not contain `Ag`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Ag atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 19057 | 0.02% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 19057 | 0.02% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 19057 | 0.02% | 100.00% |
