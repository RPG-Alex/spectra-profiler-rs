# `Cu` profile for `pubchem`

This report summarizes how often the target element `Cu` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Cu`. A molecule is **negative** when its formula does not contain `Cu`.
...
| Positive count | 67108 |
| Negative count | 123863081 |
| Positive percentage | 0.0541% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Cu`.
The `0` row represents formulas that do not contain `Cu`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Cu atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 67108 | 0.05% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 67108 | 0.05% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 67108 | 0.05% | 100.00% |
