# `Na` profile for `pubchem`

This report summarizes how often the target element `Na` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `Na`. A molecule is **negative** when its formula does not contain `Na`.
...
| Positive count | 409200 |
| Negative count | 123520989 |
| Positive percentage | 0.3302% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `Na`.
The `0` row represents formulas that do not contain `Na`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="Na atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 409200 | 0.33% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 409200 | 0.33% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 409200 | 0.33% | 100.00% |
