# `At` profile for `pubchem`

This report summarizes how often the target element `At` appears across metadata groups in `pubchem`.

## How to interpret this report

This report treats each molecule as **positive** when its molecular formula contains the target element `At`. A molecule is **negative** when its formula does not contain `At`.
...
| Positive count | 1114 |
| Negative count | 123929075 |
| Positive percentage | 0.0009% |

## Atom-count distribution

This section shows how many formula-bearing molecules have exactly `k` atoms of `At`.
The `0` row represents formulas that do not contain `At`.

[CSV table](tables/target_atom_count_distribution.csv)

<img src="figures/target_atom_count_distribution.svg" alt="At atom-count distribution" />
...
|---|---|---:|---:|---:|---:|
| Source dataset | PubChem | 123930189 | 1114 | 0.00% | 100.00% |
| Source dataset | TOTAL_RECORDS | 123930189 | 1114 | 0.00% | 100.00% |
| Source dataset | TOTAL_ASSIGNMENTS | 123930189 | 1114 | 0.00% | 100.00% |
